...
export default function LikeButton({ publication }) {
  ...
  return (
    <>
      <button
        onClick={dataIsLike.isLike ? handleRemoveLike : handleAddLike}
        className={dataIsLike.isLike ? 'love active' : 'love'}
      >
      ...
      <p className="mt-0.5 ml-2 mr-2 font-light text-base text-gray-400">
        {getCountLikes} {getCountLikes === 1 ? 'like' : 'likes'}
      </p>
    </>
  );
}
