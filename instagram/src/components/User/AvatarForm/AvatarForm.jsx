          ...
          <ul className=" space-y-3">
            <li>
              <button
                {...getRootProps()}
                loading={loading ? 1 : 0}
                className="text-white w-full items-center justify-center bg-blue-500 dark:bg-gray-800 rounded-lg hover:bg-blue-600 group
                hover:shadow dark:hover:bg-gray-700 font-medium  text-sm px-5 py-2.5 text-center mr-2 inline-flex "
              >
                {loading ? (
                  <svg
                    role="status"
            ...
            <li>
              <button
                onClick={onDelete}
                className="flex w-full items-center p-3 text-sm font-bold text-white bg-red-500 rounded-lg hover:bg-red-600 group hover:shadow  dark:hover:bg-red-600 dark:text-white cursor-pointer"
              >
            ...
            <li>
              <button
                ...
                className="flex w-full items-center p-3 text-sm font-bold
