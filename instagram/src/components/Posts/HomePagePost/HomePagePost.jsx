...
export default function HomePagePost() {
  return (
    <section className="px-5 self-start xl:w-4/6 ">
      <div className="flex max-w-xl my-10 bg-white dark:bg-darktheme-navbar shadow-md rounded-lg overflow-hidden mx-auto">
          ...
          <div className="w-full">
            ...
            <div className="flex w-full">
              <div className="mt-3 mx-5 flex flex-row">
                <div className="flex text-gray-500 font-normal text-sm rounded-md mb-2 mr-4 items-center">
                  Comments:
