    ...
    <form className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
      ...
      <div type="submit" className="relative inline-flex group w-full mt-5">
        ...
        <button
          ...
          className=" w-full relative inline-flex items-center justify-center px-6 py-3 text-sm font-medium text-white transition-all duration-200 bg-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 cursor-pointer"
        >
          Inicia sesion
        </button>
      </div>
